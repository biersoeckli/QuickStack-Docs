...
<SchemaOrg 
  ...
  description="Back up and restore the QuickStack configuration database including projects, users, and app settings."
  keywords="QuickStack, backup, restore, configuration, SQLite, system backup, S3"
  datePublished="2026-01-02"
  dateModified="2026-02-28"
  articleSection="How-to / Backups"
  inLanguage="en"
  proficiencyLevel="Intermediate"
  operatingSystem="Linux"
  mainEntityOfPage="https://quickstack.dev/docs/how-to/backups/system-backups"
/>
...
System backups cover the QuickStack configuration only — **not** your application data volumes or database contents. Set up [volume backups](./volume-backups.mdx) and [database backups](./database-backups.mdx) separately.
:::
