...
<SchemaOrg 
  type="TechArticle"
  title="Internal Networking in QuickStack"
  description="Internal container ports and service-to-service communication between apps in the same QuickStack project."
  keywords="QuickStack, networking, internal port, container port, service communication, internal hostname"
  ...
  mainEntityOfPage="https://quickstack.dev/docs/how-to/networking/internal-networking"
/>
...
- [Custom domains](./domains.mdx)
- [Network policies](./network-policies.mdx)
- [Ports & endpoints reference](../../reference/ports-and-endpoints.mdx)
