...
<SchemaOrg 
  ...
  mainEntityOfPage="https://quickstack.dev/docs/how-to/observability/health-checks"
/>
...
<img  src="/img/docs/managing-apps/health-check/health-check-http.png" alt="Health Check Settings" style={{
    marginBottom: '20px',
    marginLeft: '30px',
    maxWidth: '600px',
    width: '90%'
