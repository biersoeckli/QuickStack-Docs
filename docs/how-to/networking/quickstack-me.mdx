...
<SchemaOrg 
  ...
  mainEntityOfPage="https://quickstack.dev/docs/how-to/networking/quickstack-me"
/>
...
<img  src="/img/docs/managing-apps/quickstackme-domains/ipv4-settings.png" alt="Public IPv4 settings" style={{
    marginBottom: '20px',
    marginLeft: '30px',
    maxWidth: '400px',
    width: '90%'
...
<img  src="/img/docs/managing-apps/quickstackme-domains/quickstack-me-domain-settings.png" alt="QuickStack.me domain settings" style={{
    marginBottom: '20px',
    marginLeft: '30px',
    maxWidth: '400px',
    width: '90%'
...
For production or public-facing apps, use a [Custom Domain](./domains.mdx) instead.
