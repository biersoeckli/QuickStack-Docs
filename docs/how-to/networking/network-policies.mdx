...
<SchemaOrg 
  ...
  mainEntityOfPage="https://quickstack.dev/docs/how-to/networking/network-policies"
/>
...
<img  src="/img/docs/managing-apps/network-policies/project-network-graph.png" alt="Project Network Graph" style={{
    marginBottom: '20px',
    marginLeft: '30px',
    maxWidth: '800px',
    width: '90%'
...
- [Basic auth](./basic-auth.mdx) — HTTP-level access restriction via Traefik
- [Internal networking](./internal-networking.mdx)
