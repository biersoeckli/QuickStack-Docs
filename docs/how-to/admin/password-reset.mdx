...
After logging in with the generated password, navigate to **Settings** → **Profile** to change your password to something more memorable. You can also enable [Two-Factor Authentication](/docs/how-to/admin/two-factor-auth) for additional security.
:::
