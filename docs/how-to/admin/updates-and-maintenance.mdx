...
<SchemaOrg 
  type="TechArticle"
  title="Updates & Maintenance in QuickStack"
  description="Update QuickStack, manage disk space, and perform k3s cluster upgrades."
  keywords="QuickStack, maintenance, update, disk space, cleanup, k3s upgrade, Longhorn upgrade"
  ...
  mainEntityOfPage="https://quickstack.dev/docs/how-to/admin/updates-and-maintenance"
/>
