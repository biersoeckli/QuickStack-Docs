...
sidebar_position: 1
title: "Volumes"
description: "Learn how to configure persistent volumes for your QuickStack application containers."
keywords: ["QuickStack", "volumes", "persistent storage", "Longhorn", "PVC"]
---
...
QuickStack provides **Volumes** for persistent data storage in your applications. Data written to a volume persists even if the container is stopped, restarted, or redeployed.
...
*  **Backups:** Volumes are backed up by QuickStack. To configure a backup schedule, refer to the [Backups guide](/docs/how-to/backups/overview).
