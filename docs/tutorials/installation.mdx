...
3. **Choose a Network Interface**
   ...
   Visit **[Cluster Setup](/docs/how-to/admin/cluster-nodes):** for further information on how to setup a cluster.
...
Now that you have QuickStack installed, you can start deploying your first application. You can deploy applications from a Docker image or a Git repository. Visit the [Managing Apps](/docs/tutorials/first-app-from-git) guide to learn more.
