...
<img src="/img/docs/getting-started/cluster/cluster-overview-one-node.png" alt="Cluster Nodes Overview" />
...
<img src="/img/docs/getting-started/cluster/cluster-add-node.png" alt="Add Cluster Node Dialog" />
...
| Red Disk indicator | Disk space low; run [cleanup](/docs/how-to/admin/updates-and-maintenance#disk-space--cleanup) or expand disk |
