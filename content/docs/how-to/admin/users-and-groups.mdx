...
Go to **Settings** → **Users & Groups**. The page has three tabs: **Users**, **Groups**, and **SSO Providers**.
...
The **OAuth Providers** column shows which external identity providers a user has linked. See [Single Sign-On](/docs/how-to/admin/single-sign-on).
...
See [Single Sign-On](/docs/how-to/admin/single-sign-on) for setup, redirect URLs, and account linking.
