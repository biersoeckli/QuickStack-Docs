...
> System backups cover the QuickStack configuration only — **not** your application data volumes or database contents. Set up [volume backups](/docs/how-to/backups/volume-backups) and [database backups](/docs/how-to/backups/database-backups) separately.
