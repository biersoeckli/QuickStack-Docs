...
> - Combine with [network policies](/docs/how-to/networking/network-policies) for sensitive apps.
...
- [Network policies](/docs/how-to/networking/network-policies) — Kubernetes-level traffic control
- [Two-factor auth](/docs/how-to/admin/two-factor-auth) — 2FA for QuickStack UI access
