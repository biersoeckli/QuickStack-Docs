...
[Node Ports](/docs/how-to/networking/node-ports) for non-HTTP traffic, and [networking & network policies](/docs/how-to/networking) for controlling which workloads may reach the app.
</Callout>
