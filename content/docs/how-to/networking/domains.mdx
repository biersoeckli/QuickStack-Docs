...
1. Open the app and click the **Domains & Networking** tab.
...
<Callout>
**The Domains & Networking tab also holds**
[Node Ports](/docs/how-to/networking/node-ports) for non-HTTP traffic, and the app's [network policy](/docs/how-to/networking/network-policies) for controlling which workloads may reach the app.
</Callout>
