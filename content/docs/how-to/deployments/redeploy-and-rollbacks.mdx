...
Copy the exact value from the app's **Domains & Networking** tab → **Network Policy** → rule actions → **Copy internal hostname**. See [Networking](/docs/how-to/networking) for details.
