...
| Builds overview (all projects) | Left sidebar → **Builds** |
...
| Build container node & resource limits | **Settings** → **QuickStack Server** → **Builds** |
...
| View all builds across projects | Left sidebar → **Builds** |
...
| Configure build node / resource limits | **Settings** → **QuickStack Server** → **Builds** tab |
