...
> **tip No domain yet?**
> Use the built-in **[QuickStack.me domain](../how-to/networking/quickstack-me.mdx)** for instant HTTPS — no DNS setup needed.

## What you need

- A deployed app (see [first app from Git](./first-app-from-git.mdx) or [first app from image](./first-app-from-image))
